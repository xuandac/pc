                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="item-one">
                            ...
                            <?php 
                            if(count($Data_Feature)>0){
                              $Img_Top = json_decode($Data_Feature[0]['Thumb'],true);  
                            ?>
                            <div class="col-md-4">
                               <a class="name-post" href="<?= $Service->makeUrl($Data_Feature[0])?>"><?= $Data_Feature[0]['Title']?></a>
                                <p class="text-justify"><?= $Service->subStringv($Data_Feature[0]['Summary'], 150)?></p>
                                <!--<ul class="list-tags">
                                   <?php
                                          $Array_Tags = explode(',', $Data_Feature[0]['Tags']);                                         
                            ...
                            <div class="col-md-8">
                                <div class="img">
                                    <a href="<?= $Service->makeUrl($Data_Feature[0]);?>"><img src="<?= $Url_Media.$Img_Top['size1']?>"/></a>
                                </div>
                            </div>
                            <?php 
                            unset($Data_Feature[0]); }                             
                            ?>
                            <?php
                        ...
                        <div class="list-new-category">
                            <?php
                                                    foreach ($Data_Feature as  $i=>$item){
